...
$browser->info('Functional test fail edit profile - Too short password')->
	...
	setField('webschool_user[pass]', '987654')->
	setField('webschool_user[passAgain]', '987654')->
	...
	with('response')->begin()->
		...
		checkElement('small.error', '/ste vara 8 tecken/')->
	end()->

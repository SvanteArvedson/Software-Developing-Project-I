...
$browser->info('Functional test fail edit password - Too short password')->
	...
	setField('webschool_user_edit_password[pass]', '9876')->
	setField('webschool_user_edit_password[passAgain]', '9876')->

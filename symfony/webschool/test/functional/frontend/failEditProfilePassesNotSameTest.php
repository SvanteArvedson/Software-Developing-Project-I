...
$browser->info('Functional test fail edit profile - Passes not same')->
	...
	setField('webschool_user[pass]', '54687913')->
	setField('webschool_user[passAgain]', '54687319')->
	...
	with('response')->begin()->
		...
		checkElement('p.error', '/och Repetera/')->
	end()->

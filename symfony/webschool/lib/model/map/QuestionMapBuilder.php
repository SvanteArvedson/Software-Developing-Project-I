...
class QuestionMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addPrimaryKey('QUESTIONID', 'Questionid', 'SMALLINT', true, null);

		$tMap->addColumn('TEXT', 'Text', 'VARCHAR', true, 255);

		$tMap->addForeignKey('ANSWERID', 'Answerid', 'INTEGER', 'answer', 'ANSWERID', true, null);

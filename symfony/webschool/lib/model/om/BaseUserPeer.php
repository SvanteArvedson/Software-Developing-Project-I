...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Userid', 'Username', 'Password', 'Name', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userid', 'username', 'password', 'name', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::USERID, self::USERNAME, self::PASSWORD, self::NAME, self::EMAIL, ),
		BasePeer::TYPE_FIELDNAME => array ('userID', 'username', 'password', 'name', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Userid' => 0, 'Username' => 1, 'Password' => 2, 'Name' => 3, 'Email' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userid' => 0, 'username' => 1, 'password' => 2, 'name' => 3, 'email' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::USERID => 0, self::USERNAME => 1, self::PASSWORD => 2, self::NAME => 3, self::EMAIL => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('userID' => 0, 'username' => 1, 'password' => 2, 'name' => 3, 'email' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

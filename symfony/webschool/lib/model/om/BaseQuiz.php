...
abstract class BaseQuiz extends BaseObject  implements Persistent {
  ...
  const PEER = 'QuizPeer';
	...
	public function setLessonid($v)
	{
		...
		if ($this->lessonid !== $v) {
			$this->lessonid = $v;
			$this->modifiedColumns[] = QuizPeer::LESSONID;
		}
	...
	public function setQuestionid($v)
	{
		...
		if ($this->questionid !== $v) {
			$this->questionid = $v;
			$this->modifiedColumns[] = QuizPeer::QUESTIONID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = QuizPeer::NUM_COLUMNS - QuizPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(QuizPeer::LESSONID)) $criteria->add(QuizPeer::LESSONID, $this->lessonid);
		if ($this->isColumnModified(QuizPeer::QUESTIONID)) $criteria->add(QuizPeer::QUESTIONID, $this->questionid);

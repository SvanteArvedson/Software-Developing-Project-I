...
abstract class BaseAnswerPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Answerid', 'Text', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('answerid', 'text', ),
		BasePeer::TYPE_COLNAME => array (self::ANSWERID, self::TEXT, ),
		BasePeer::TYPE_FIELDNAME => array ('answerID', 'text', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Answerid' => 0, 'Text' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('answerid' => 0, 'text' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ANSWERID => 0, self::TEXT => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('answerID' => 0, 'text' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AnswerPeer::ANSWERID);

		$criteria->addSelectColumn(AnswerPeer::TEXT);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseAnswerPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(AnswerPeer::ANSWERID) && $criteria->keyContainsValue(AnswerPeer::ANSWERID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.AnswerPeer::ANSWERID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseAnswerPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(AnswerPeer::ANSWERID);
			$selectCriteria->add(AnswerPeer::ANSWERID, $criteria->remove(AnswerPeer::ANSWERID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AnswerPeer::ANSWERID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(AnswerPeer::ANSWERID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
			$criteria->add(AnswerPeer::ANSWERID, $pks, Criteria::IN);

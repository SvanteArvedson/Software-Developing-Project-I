...
I iteration 1 hann jag inte sä långt som jag hade planerat att göra av flera 
...
min HelloWorld-applikation (test för att se att allt fungerar). Publiseringen 
fungerade inte och då felmeddelandena var avstängda fick jag debugga manuellt, 
och det tog lång tid. Jag hittade felet som hoppas kunna lösa det med min 
